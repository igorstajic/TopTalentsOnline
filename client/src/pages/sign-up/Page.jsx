...
function SignUp({ history, enqueueSnackbar }: { history: Object, enqueueSnackbar: Function }) {
  ...
  return (
    <Fade in={true}>
      <Container component="section" maxWidth="xs" data-testid="page_container__signup">
        <div className={classes.paper}>
          ...
          <form className={classes.form} noValidate onSubmit={onSubmit}>
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <TextField
                  name="firstName"
                  variant="outlined"
                  inputProps={{"data-testid":"input__firstName"}}
                  required
                  fullWidth
                  id="firstName"
                  label="First Name"
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  required
                  fullWidth
                  inputProps={{"data-testid":"input__lastName"}}
                  id="lastName"
                  label="Last Name"
                  name="lastName"
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  required
                  fullWidth
                  inputProps={{"data-testid":"input__email"}}
                  id="email"
                  label="Email Address"
                  name="email"
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  required
                  fullWidth
                  inputProps={{"data-testid":"input__password"}}
                  name="password"
                  label="Password"
                  type="password"
                  id="password"
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  required
                  fullWidth
                  inputProps={{"data-testid":"input__passwordConfirmation"}}
            ...
            <Button data-testid="action__submit" type="submit" fullWidth variant="contained" color="primary" className={classes.submit}>
              Sign Up
            </Button>
